...
// Cambia la tarjeta de una suscripción YA autorizada (para renovar o
// corregir el medio de pago). Ojo: esto NO sirve para completar/autorizar
// una suscripción "pending" — MercadoPago exige que esa autorización la dé
// la propia persona pagadora desde su checkout (ver crearPreapproval /
// init_point), no se puede forzar por API con solo un card_token_id.
