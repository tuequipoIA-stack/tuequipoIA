import {
  ...
  Sparkles, Kanban, Contact, Rows3, Mail, MessageCircle, BarChart3,
} from "lucide-react";
...
export const PANEL_NAV_ITEMS = [
  { id: "panel-resumen", label: "Resumen", icon: BarChart3 },
  { id: "panel-membresias", label: "Membresías", icon: Sparkles },
  { id: "panel-apps", label: "Apps a Medida", icon: Package },
  { id: "panel-seguimiento", label: "Seguimiento de Interesados", icon: Kanban },
  { id: "panel-cobros", label: "Cobros", icon: Wallet },
  { id: "panel-contactos", label: "Todos los Contactos", icon: Contact },
  { id: "panel-listas", label: "Listas de Contactos", icon: Rows3 },
  { id: "panel-correos", label: "Armado de Correos", icon: Mail },
  { id: "panel-difusion", label: "Difusión WhatsApp", icon: MessageCircle },
];
