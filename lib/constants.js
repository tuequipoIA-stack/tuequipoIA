import {
  ...
  Sparkles, Contact, BarChart3, Send,
} from "lucide-react";

export const BRAND = { teal: "#1AABAA", navy: "#1A1A2E", cream: "#F4F1EC" };

// Contacto (mismo que usa el botón de Ayuda) y datos bancarios para pagar
// la membresía por transferencia — la activación posterior es manual,
// desde Admin → "Activar manualmente".
export const EMAIL_CONTACTO = "tuequipoia@gmail.com";
export const WHATSAPP_NUMERO = "2617268115";
export const WHATSAPP_LINK = `https://wa.me/549${WHATSAPP_NUMERO}`;

export const DATOS_TRANSFERENCIA = [
  { label: "CBU", valor: "4530000800012952180536" },
  { label: "Alias", valor: "TUEQUIPOIA" },
  { label: "Tipo de cuenta", valor: "Caja de ahorro en pesos" },
  { label: "Número de cuenta", valor: "1295218053" },
  { label: "Titular", valor: "Marisa Antonella Ropero" },
  { label: "CUIL", valor: "27370914902" },
  { label: "Banco", valor: "Naranja X" },
];
...
// Monedas disponibles al cargar un producto/servicio en Finanzas → Costos.
// El símbolo se usa solo para mostrar ese costo puntual; el resto de la app
// (totales, dashboard, etc.) sigue mostrando todo en pesos como siempre.
export const MONEDAS = [
  { id: "ARS", simbolo: "$", label: "Pesos argentinos (ARS)" },
  { id: "USD", simbolo: "US$", label: "Dólares (USD)" },
  { id: "EUR", simbolo: "€", label: "Euros (EUR)" },
];
...
// Secciones del Panel de Comunicación (CRM interno), visibles solo para el
// admin de tuequipoia.com.ar. Los ids llevan el prefijo "panel-" para no
// pisar los ids de NAV_ITEMS dentro del mismo estado `section` de AppShell.
export const PANEL_NAV_ITEMS = [
  { id: "panel-hoy", label: "Hoy", icon: BarChart3 },
  { id: "panel-segmentos", label: "Segmentos", icon: Sparkles },
  { id: "panel-envios", label: "Envíos", icon: Send },
  { id: "panel-contactos", label: "Contactos", icon: Contact },
];

// Agrupa los botones de la barra lateral en 2 grupos colapsables:
// "TuequipoIA" (todo lo existente) y "TuequipoIA Panel" (CRM, solo admin).
export const NAV_GROUPS = [
  { id: "tuequipoia", label: "TuequipoIA", items: NAV_ITEMS, adminOnly: false },
  { id: "tuequipoia-panel", label: "TuequipoIA Panel", items: PANEL_NAV_ITEMS, adminOnly: true },
];
...
// Sub-selección de modos de CRM cuando el negocio es "Servicios" (ver
// Onboarding y PerfilSection). Se guarda como array en unidades_negocio.crm_modos.
export const CRM_MODOS = [
  { id: "pipeline", label: "Proyectos o tratos con cierre", desc: "Cotizás, negociás y cerrás un trabajo puntual. Incluye la opción de dejarlo con mantenimiento mensual después de entregado." },
  { id: "suscripciones", label: "Suscripción o membresía", desc: "Cobrás un monto recurrente por un servicio continuo (plan, membresía, servicio mensual)." },
  { id: "pacientes", label: "Atención de pacientes o clientes recurrentes", desc: "Atendés a la misma persona en sesiones o consultas a lo largo del tiempo, sin que cada una sea una venta nueva." },
];

// El CRM (sección de menú con los modos Pipeline/Suscripciones/Pacientes)
// se muestra solo si CRM_HABILITADO está en true Y el negocio tiene algún
// modo activo en unidades_negocio.crm_modos (ver Sidebar/AppShell). El flag
// sigue el mismo patrón que EQUIPO_HABILITADO, como apagado de emergencia.
export const CRM_HABILITADO = true;

// Etapas del pipeline de prospectos (crm_prospectos.etapa) — mismos valores
// que el check constraint en Supabase. "ganado" y "perdido" se muestran
// juntos como una sola columna en el tablero, pero son valores separados.
export const CRM_ETAPAS_PIPELINE = [
...
// Estados de cobro del modo CRM "Suscripciones" (crm_suscripciones.estado_cobro)
// — mismos valores que el check constraint en Supabase.
export const CRM_ESTADOS_SUSCRIPCION = [
...
// Fases del vínculo del modo CRM "Pacientes" (crm_pacientes.fase) — mismos
// valores que el check constraint en Supabase.
export const CRM_FASES_PACIENTE = [
  { id: "primera_consulta", label: "Primera consulta" },
  { id: "tratamiento_activo", label: "Tratamiento activo" },
  { id: "seguimiento_espaciado", label: "Seguimiento espaciado" },
  { id: "alta_pausa", label: "Alta / Pausa" },
];

// Etapas de seguimiento de un proyecto ganado (ventas_proyectos.etapa_seguimiento)
// — mismos valores que el check constraint. "en_mantenimiento" solo es
// alcanzable si el proyecto tiene mantenimiento_activo.
export const VENTAS_ETAPAS_SEGUIMIENTO = [
  { id: "contrato_firmado", label: "Contrato firmado" },
  { id: "kickoff", label: "Kickoff" },
  { id: "en_desarrollo", label: "En desarrollo" },
  { id: "revision_entrega", label: "Revisión/Entrega" },
...
export const TIPOS_PUBLICACION = ["Post Instagram", "Historia Instagram", "Carrusel Instagram", "Reel", "Post LinkedIn", "Video TikTok", "Video YouTube", "Podcast", "Newsletter", "Otro"];
...
export const TIPO_COLORES = {
  ...
  "Carrusel Instagram": { bg: "#F77737", text: "#ffffff" },
  "Reel": { bg: "#C13584", text: "#ffffff" },
  "Post LinkedIn": { bg: "#0A66C2", text: "#ffffff" },
  "Video TikTok": { bg: "#010101", text: "#ffffff" },
  "Video YouTube": { bg: "#FF0000", text: "#ffffff" },
  "Podcast": { bg: "#7C3AED", text: "#ffffff" },
...
// Los 4 pilares de contenido "principales" (más el 5to transversal, definido
// aparte en PilaresContenidoTab). Centralizados acá porque los usa tanto
// PilaresContenidoTab (la guía) como ComunicacionMensualTab (el calendario
// editorial mes a mes) — mismos textos en los dos lugares.
export const PILARES_CONTENIDO = [
  {
    id: "educativo", numero: "01", porcentaje: "25%", etiqueta: "Atracción", titulo: "Educativo",
  ...
  {
    id: "inspiracional", numero: "02", porcentaje: "25%", etiqueta: "Conexión", titulo: "Inspiracional",
  ...
  {
    id: "pruebasocial", numero: "03", porcentaje: "20%", etiqueta: "Autoridad", titulo: "Prueba social",
  ...
  {
    id: "ofertadirecta", numero: "04", porcentaje: "20%", etiqueta: "Venta", titulo: "Oferta directa",
