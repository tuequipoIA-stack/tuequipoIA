...
export const AUDIO_GUIONES = {
  ...
  "ventas:carga":
    "Esta es la pestaña de Carga diaria. Acá cargás cada producto vendido, día por día, y ves el total vendido y el margen real del mes.",
  "ventas:dashboard":
    "Esta es la pestaña de Dashboard, dentro de Ventas. Acá ves todos tus movimientos juntos y los podés filtrar por fecha, por mes, por producto o por rango de facturación, y ordenarlos como prefieras.",
