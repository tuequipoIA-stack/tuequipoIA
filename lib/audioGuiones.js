...
export const AUDIO_GUIONES = {
  ...
  "ventas:seguimiento":
    "Esta es la pestaña de Seguimiento, dentro de Ventas. Acá aparecen los proyectos que ganaste desde el CRM, organizados en un tablero desde Contrato firmado hasta Cobrado (y En mantenimiento si corresponde). Tocá cualquier tarjeta para ver su ficha completa: resumen, avance con hitos, y facturación y cobro.",
